...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="accountForm" runat="server" DefaultButton="btnSubmitEdit">
        <div id="accountWrapper">
            ...
            <p>Password:</p> <asp:Button ID="btnChangePassword" Text="Change Password" runat="server" class="button" OnClick="btnChangePassword_Click"/>

            <p>Display Name:</p> <asp:TextBox ID="txt_displayName" runat="server" />

            <p>E-mail Address:</p> <asp:TextBox ID="txt_email" runat="server" />
